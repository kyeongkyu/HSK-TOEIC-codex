...
const EXAMPLES: Record<HskListeningTopic, Record<HskListeningLevel, Example>> = {
  daily_life: {
    ...
    3: { text: '我每天吃完早饭以后去跑步。', pinyin: 'wo3 mei3tian1 chi1 wan2 zao3fan4 yi3hou4 qu4 pao3bu4.', translation: '나는 매일 아침을 먹은 뒤에 달리기를 하러 갑니다.', keyword: '跑步', subtopics: ['daily_routine', 'sequence'], patternTags: ['after_action'] },
    4: { text: '如果晚上不加班，我通常会自己做饭。', pinyin: 'ru2guo3 wan3shang bu4 jia1ban1, wo3 tong1chang2 hui4 zi4ji3 zuo4 fan4.', translation: '저녁에 야근하지 않으면 나는 보통 직접 밥을 합니다.', keyword: '自己做饭', subtopics: ['daily_routine', 'food'], patternTags: ['conditional'] },
    5: { text: '养成规律的作息习惯，对提高学习效率很有帮助。', pinyin: 'yang3cheng2 gui1lv4 de zuo4xi2 xi2guan4, dui4 ti2gao1 xue2xi2 xiao4lv4 hen3 you3 bang1zhu4.', translation: '규칙적인 생활 습관을 기르는 것은 학습 효율을 높이는 데 도움이 됩니다.', keyword: '规律的作息习惯', subtopics: ['daily_routine', 'habit'], patternTags: ['abstract_noun'] },
  ...
  school_learning: {
    ...
    4: { text: '为了准备口语考试，他每天跟同学练习对话。', pinyin: 'wei4le zhun3bei4 kou3yu3 kao3shi4, ta1 mei3tian1 gen1 tong2xue2 lian4xi2 dui4hua4.', translation: '말하기 시험을 준비하기 위해 그는 매일 친구와 대화를 연습합니다.', keyword: '口语考试', subtopics: ['speaking', 'exam'], patternTags: ['purpose'] },
    5: { text: '只靠背单词不够，还要理解词语在句子里的用法。', pinyin: 'zhi3 kao4 bei4 dan1ci2 bu2 gou4, hai2 yao4 li3jie3 ci2yu3 zai4 ju4zi li3 de yong4fa3.', translation: '단어 암기만으로는 부족하고, 단어가 문장 안에서 어떻게 쓰이는지도 이해해야 합니다.', keyword: '用法', subtopics: ['vocabulary', 'grammar'], patternTags: ['contrast'] },
  ...
  work_business: {
    1: { text: '爸爸今天去公司工作。', pinyin: 'ba4ba jin1tian1 qu4 gong1si1 gong1zuo4.', translation: '아버지는 오늘 회사에 일하러 갑니다.', keyword: '公司', subtopics: ['office'], patternTags: ['go_to_place'] },
    ...
    6: { text: '公司决定调整销售策略，以应对不断变化的市场需求。', pinyin: 'gong1si1 jue2ding4 tiao2zheng3 xiao1shou4 ce4lve4, yi3 ying4dui4 bu2duan4 bian4hua4 de shi4chang3 xu1qiu2.', translation: '회사는 변화하는 시장 수요에 대응하기 위해 판매 전략을 조정하기로 결정했습니다.', keyword: '销售策略', subtopics: ['strategy', 'market'], patternTags: ['purpose_formal'] },
  },
  people_relationships: {
    ...
    3: { text: '他邀请同事周末来家里吃饭。', pinyin: 'ta1 yao1qing3 tong2shi4 zhou1mo4 lai2 jia1li chi1fan4.', translation: '그는 동료를 주말에 집으로 초대해 식사하려고 합니다.', keyword: '邀请', subtopics: ['invitation', 'colleague'], patternTags: ['invite'] },
    ...
    6: { text: '在人际交往中，尊重差异往往比急于表达观点更重要。', pinyin: 'zai4 ren2ji4 jiao1wang3 zhong1, zun1zhong4 cha1yi4 wang3wang3 bi3 ji2yu2 biao3da2 guan1dian3 geng4 zhong4yao4.', translation: '인간관계에서는 차이를 존중하는 것이 서둘러 의견을 표현하는 것보다 더 중요할 때가 많습니다.', keyword: '尊重差异', subtopics: ['communication', 'values'], patternTags: ['comparison'] },
  },
  shopping_services: {
    ...
    2: { text: '请给我一杯热茶。', pinyin: 'qing3 gei3 wo3 yi4 bei1 re4 cha2.', translation: '따뜻한 차 한 잔 주세요.', keyword: '一杯', subtopics: ['ordering', 'measure_word'], patternTags: ['polite_request'] },
  ...
  transport_travel: {
    ...
    6: { text: '完善的公共交通系统能够显著降低城市居民的出行成本。', pinyin: 'wan2shan4 de gong1gong4 jiao1tong1 xi4tong3 neng2gou4 xian3zhu4 jiang4di1 cheng2shi4 ju1min2 de chu1xing2 cheng2ben3.', translation: '잘 갖춰진 대중교통 시스템은 도시 주민의 이동 비용을 크게 낮출 수 있습니다.', keyword: '公共交通系统', subtopics: ['public_transport', 'society'], patternTags: ['formal_effect'] },
  },
  health: {
    1: { text: '我今天不太舒服。', pinyin: 'wo3 jin1tian1 bu2 tai4 shu1fu.', translation: '나는 오늘 몸이 별로 좋지 않습니다.', keyword: '不太舒服', subtopics: ['symptom'], patternTags: ['degree'] },
    ...
    6: { text: '保持心理健康和保持身体健康一样值得重视。', pinyin: 'bao3chi2 xin1li3 jian4kang1 he2 bao3chi2 shen1ti3 jian4kang1 yi2yang4 zhi2de2 zhong4shi4.', translation: '정신 건강을 유지하는 것은 신체 건강을 유지하는 것만큼 중요하게 여길 가치가 있습니다.', keyword: '心理健康', subtopics: ['mental_health'], patternTags: ['as_as'] },
  },
  public_places: {
    ...
    4: { text: '博物馆周一不开门，请明天再来。', pinyin: 'bo2wu4guan3 zhou1yi1 bu4 kai1men2, qing3 ming2tian1 zai4 lai2.', translation: '박물관은 월요일에 열지 않으니 내일 다시 오세요.', keyword: '不开门', subtopics: ['museum', 'opening_hours'], patternTags: ['schedule'] },
  ...
  culture_society: {
    ...
    3: { text: '春节的时候，很多人回家看父母。', pinyin: 'chun1jie2 de shi2hou, hen3 duo1 ren2 hui2 jia1 kan4 fu4mu3.', translation: '춘절 때 많은 사람들이 부모님을 보러 집에 갑니다.', keyword: '春节', subtopics: ['festival', 'family'], patternTags: ['when_clause'] },
    ...
    5: { text: '随着互联网的发展，人们获取新闻的方式发生了很大变化。', pinyin: 'sui2zhe5 hu4lian2wang3 de fa1zhan3, ren2men huo4qu3 xin1wen2 de fang1shi4 fa1sheng1 le hen3 da4 bian4hua4.', translation: '인터넷의 발전에 따라 사람들이 뉴스를 얻는 방식이 크게 변했습니다.', keyword: '互联网', subtopics: ['media', 'society'], patternTags: ['with_development'] },
    6: { text: '传统文化并不是一成不变的，它会在现代社会中不断产生新的表达方式。', pinyin: 'chuan2tong3 wen2hua4 bing4 bu2 shi4 yi4cheng2bu2bian4 de, ta1 hui4 zai4 xian4dai4 she4hui4 zhong1 bu2duan4 chan3sheng1 xin1 de biao3da2 fang1shi4.', translation: '전통문화는 결코 변하지 않는 것이 아니라 현대 사회 속에서 계속 새로운 표현 방식을 만들어 냅니다.', keyword: '传统文化', subtopics: ['tradition', 'society'], patternTags: ['not_fixed'] },
  },
};
...
function makeQuestion(
  ...
  return {
    ...
    explanation: isFillBlank
      ? `빈칸의 핵심 표현은 "${example.keyword}"입니다. 먼저 소리에서 의미 단위를 찾아보세요.`
      : activityType === 'dictation'
        ? '받아쓰기는 한자 누락과 숫자/시간 표현을 정확히 듣는 것이 핵심입니다.'
        : `듣기 포인트는 "${example.keyword}"입니다.`,
